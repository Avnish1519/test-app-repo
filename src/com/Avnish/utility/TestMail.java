...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "SwiftCart.alumni@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to SwiftCart</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with SwiftCart.<br>"
					...
					+ "<span class='greenText'>SwiftCart500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
